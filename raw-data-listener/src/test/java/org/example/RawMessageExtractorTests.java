...
public class RawMessageExtractorTests {
    ...
    @InjectMocks
    private RawMessageExtractor rawMessageExtractor;
    @Captor
    ArgumentCaptor<ExtractedAisMessage> extractedAisMessageArgumentCaptor;


    @Test
    public void testParsingIncomingMessage() {
        // == Arrange
        List<Integer> hex = List.of(33, 66,83,86,68,77,44,49,44,49,44,44,65,44,49,51,81,101,118,118,48,48,49,101,48,70,99,55,100,81,48,86,71,70,63,109,52,68,48,48,82,67,44,48,42,49,69);
        ...
        Mockito.verify(applicationEventPublisher).publishEvent(extractedAisMessageArgumentCaptor.capture());
        // == Assert
